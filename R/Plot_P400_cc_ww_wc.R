...
library(rstan)
set.seed(3)
sphoto_c.c <- stan(file = "R/FitPhoto400.stan",
...
sphoto_w.w <- stan(file = "R/FitPhoto400.stan",
...
sphoto_w.c <- stan(file = "R/FitPhoto400.stan",
...
p1_topt_10 <- geom_vline(aes(
  xintercept=summary(sphoto_w.w, probs = c(0.025,0.1,0.5,0.9,0.975))$summary["Topt","10%"]-273.15), 
  col='red',lty=3)
p1_topt_90 <- geom_vline(aes(
  xintercept=summary(sphoto_w.w, probs = c(0.025,0.1,0.5,0.9,0.975))$summary["Topt","90%"]-273.15), 
  col='red',lty=3)
...
p2_topt <- geom_vline(aes(xintercept=summary(sphoto_w.c)$summary["Topt","50%"]-273.15), 
                      col='blue')
p2_topt_2.5 <- geom_vline(aes(xintercept=summary(sphoto_w.c)$summary["Topt","2.5%"]-273.15), 
                          col='blue',lty=3)
p2_topt_97.5 <- geom_vline(aes(xintercept=summary(sphoto_w.c)$summary["Topt","97.5%"]-273.15), 
                           col='blue',lty=3)
p2_topt_10 <- geom_vline(aes(
  xintercept=summary(sphoto_w.c, probs = c(0.025,0.1,0.5,0.9,0.975))$summary["Topt","10%"]-273.15), 
  col='blue',lty=3)
p2_topt_90 <- geom_vline(aes(
  xintercept=summary(sphoto_w.c, probs = c(0.025,0.1,0.5,0.9,0.975))$summary["Topt","90%"]-273.15), 
  col='blue',lty=3)

p400_w.w_w.c <- p1+p2_lines+p2_points+p1_topt+p2_topt+p1_topt_10+p1_topt_90+p2_topt_10+p2_topt_90
ggsave("figures/p400_w.w_w.c.png",plot=p400_w.w_w.c, width = 120, height=100, units='mm')
...
p2_points <- geom_point(data=tmp2, aes(Tk-273.15,Photo), size=4, 
                        col='blue', show.legend = F, inherit.aes = F)
p2_topt <- geom_vline(aes(xintercept=summary(sphoto_c.c)$summary["Topt","50%"]-273.15), 
                      col='blue')
p2_topt_2.5 <- geom_vline(aes(xintercept=summary(sphoto_c.c)$summary["Topt","2.5%"]-273.15), 
                          col='blue',lty=3)
p2_topt_97.5 <- geom_vline(aes(xintercept=summary(sphoto_c.c)$summary["Topt","97.5%"]-273.15), 
                           col='blue',lty=3)
p2_topt_10 <- geom_vline(aes(
