...
ggsave(p4/p5/p6,
       filename = paste0("figures/photo_Topt/Fig1_p800_parabolicFit_CI80_",Sys.Date(),".png"),
       width = 120, height=3*100, units='mm')
...
ggsave((p1/p2/p3)|(p4/p5/p6),
       filename = paste0("figures/photo_Topt/Fig1_p400_p800_parabolicFit_CI80_",Sys.Date(),".png"),
       width = 2*120, height=3*100, units='mm')
ggsave((p1/p2/p3)|(p4/p5/p6),
       filename = paste0("figures/photo_Topt/Fig1_p400_p800_parabolicFit_CI80_",Sys.Date(),".pdf"),
       width = 2*120, height=3*100, units='mm')
