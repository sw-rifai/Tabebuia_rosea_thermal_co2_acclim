...
parr_vcmax
plot(parr_vcmax, ask=F)
pp_check(parr_vcmax, nsamples = 30, ask=F)
...
parr_jmax
plot(parr_jmax, ask=F)
pp_check(parr_jmax, nsamples = 30, ask=F)
...
ggsave((p1/p2/p3)|(p4/p5/p6),
       filename = paste0("figures/Fig3_vcmax_jmax_brms_",Sys.Date(),".png"),
       width = 2*120, height=3*100, units='mm')
ggsave((p1/p2/p3)|(p4/p5/p6),
       filename = paste0("figures/Fig3_vcmax_jmax_brms_",Sys.Date(),".pdf"),
       width = 2*120, height=3*100, units='mm')
